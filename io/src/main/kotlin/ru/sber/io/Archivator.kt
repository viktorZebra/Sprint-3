...
class Archivator {
     ...
     */
    fun zipLogfile(filePath: String = "logfile.log", zipFilePath: String = "logfile.zip") {
        try {
     ...
     */
    fun unzipLogfile(filePath: String = "unzippedLogfile.log", zipFilePath: String = "logfile.zip") {
        try {
